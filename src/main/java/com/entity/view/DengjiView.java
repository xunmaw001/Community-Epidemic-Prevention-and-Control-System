 ...
 */
@TableName("dengji")
public class DengjiView extends DengjiEntity implements Serializable {
	...
	public DengjiView(DengjiEntity dengjiEntity) {
		try {
			BeanUtils.copyProperties(this, dengjiEntity);
