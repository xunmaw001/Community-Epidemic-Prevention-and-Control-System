        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">疫情上报管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">疫情上报列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">疫情上报列表</h3>
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            // row.appendChild(zhuhuTimeCell);
                ...
                //上报详情
            var shangbaoContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.shangbaoContent && item.shangbaoContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.shangbaoContent.indexOf('<img');
                var endIndex = item.shangbaoContent.indexOf('>');
                    shangbaoContentCell.innerHTML = item.shangbaoContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.shangbaoContent != null && item.shangbaoContent != "" && item.shangbaoContent.length >= 11) {
                        shangbaoContentCell.innerHTML = item.shangbaoContent.substring(0, 10) + "...";
                } else {
                        shangbaoContentCell.innerHTML = item.shangbaoContent;
                }
            }
            row.appendChild(shangbaoContentCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("shangbao/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addshangbao", "addshangbao");
            window.location.href = "add-or-update.jsp"
        }
