            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">出入登记登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <div class="form-group col-md-6">
                                    <label>出入类型</label>
                                    <input id="dengjiValue" name="dengjiValue" class="form-control"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="laiAddress" name="laiAddress" class="form-control"
                                               v-model="ruleForm.laiAddress" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="quAddress" name="quAddress" class="form-control"
                                               v-model="ruleForm.quAddress" readonly>
                                    </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.dengjiContent != null && ruleForm.dengjiContent != 'null' && ruleForm.dengjiContent != '') {
            var dengjiContentUeditor = UE.getEditor('dengjiContentEditor');
                dengjiContentUeditor.ready(function () {
                    var mes = '' + ruleForm.dengjiContent;
                    dengjiContentUeditor.setContent(mes);
                    dengjiContentUeditor.setDisabled('fullscreen');
            });
        }
    }
