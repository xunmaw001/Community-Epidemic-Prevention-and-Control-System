...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">出入登记管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">出入登记管理</li>
                            <li class="breadcrumb-item active">出入登记列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">出入登记列表</h3>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <select name="dengjiTypesSelectSearch"  style="width: 150px;" id="dengjiTypesSelectSearch" class="form-control form-control-sm"
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            if(zhuhuTypesSelectSearchInput != null){
                ...
                //出入类型
            var dengjiTypesSelectSearchInput = document.getElementById("dengjiTypesSelectSearch");
            if(dengjiTypesSelectSearchInput != null){
                var dengjiTypesIndex = dengjiTypesSelectSearchInput.selectedIndex;
                if( dengjiTypesIndex  != 0){
                    searchForm.dengjiTypes= document.getElementById("dengjiTypesSelectSearch").options[dengjiTypesIndex].value;
                }
            }
        ...
        function getDataList() {
            http("dengji/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,
                order: sortOrder,
                //本表的
                dengjiTypes: searchForm.dengjiTypes,
        ...
        function setDataRow(item, number) {
            ...
            //从哪来
            var laiAddressCell = document.createElement('td');
            laiAddressCell.innerHTML = item.laiAddress;
            row.appendChild(laiAddressCell);


            //到哪去
            var quAddressCell = document.createElement('td');
            quAddressCell.innerHTML = item.quAddress;
            row.appendChild(quAddressCell);


                //备注
            var dengjiContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.dengjiContent && item.dengjiContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.dengjiContent.indexOf('<img');
                var endIndex = item.dengjiContent.indexOf('>');
                    dengjiContentCell.innerHTML = item.dengjiContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.dengjiContent != null && item.dengjiContent != "" && item.dengjiContent.length >= 11) {
                        dengjiContentCell.innerHTML = item.dengjiContent.substring(0, 10) + "...";
                } else {
                        dengjiContentCell.innerHTML = item.dengjiContent;
                }
            }
            row.appendChild(dengjiContentCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("dengji/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("adddengji", "adddengji");
            window.location.href = "add-or-update.jsp"
        }
    ...
    //填充本表搜索下拉框
        ...
        function dengjiTypesSelectSearch() {
            var dengjiTypesSelectSearch = document.getElementById('dengjiTypesSelectSearch');
            if(dengjiTypesSelectSearch != null) {
                dengjiTypesSelectSearch.add(new Option('-请选择-',''));
                if (dengjiTypesOptions != null && dengjiTypesOptions.length > 0){
                    for (var i = 0; i < dengjiTypesOptions.length; i++) {
                            dengjiTypesSelectSearch.add(new Option(dengjiTypesOptions[i].indexName,dengjiTypesOptions[i].codeIndex));
                    }
                }
            }
        }
