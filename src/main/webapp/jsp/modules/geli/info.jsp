            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">隔离监控登记</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="gongzuoId" name="gongzuoId" v-model="ruleForm.gongzuoId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>隔离开始时间</label>
                                        <input id="geliStartTime" name="geliStartTime" class="form-control"
                                               v-model="ruleForm.geliStartTime" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>隔离结束时间</label>
                                        <input id="geliEndTime" name="geliEndTime" class="form-control"
                                               v-model="ruleForm.geliEndTime" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="geliAddress" name="geliAddress" class="form-control"
                                               v-model="ruleForm.geliAddress" readonly>
                                    </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.geliContent != null && ruleForm.geliContent != 'null' && ruleForm.geliContent != '') {
            var geliContentUeditor = UE.getEditor('geliContentEditor');
                geliContentUeditor.ready(function () {
                    var mes = '' + ruleForm.geliContent;
                    geliContentUeditor.setContent(mes);
                    geliContentUeditor.setDisabled('fullscreen');
            });
        }
    }
