...
<!--/Pre Loader -->
                ...
                <div class="row breadcrumb-bar">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">来访登记列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="laifangNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        手机号
                                        <div class="layui-input-inline">
                                            <input type="text" id="laifangPhoneSearch" style="width: 140px;" class="form-control form-control-sm"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        身份证号
                                        <div class="layui-input-inline">
                                            <input type="text" id="laifangIdNumberSearch" style="width: 140px;" class="form-control form-control-sm"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        体温
                                        <div class="layui-input-inline">
                                            <input type="text" id="tiwenStartSearch" style="width: 100px;" class="form-control form-control-sm" onchange="tiwenChickValue(this)"
                                                   placeholder="开始" aria-controls="tableId">
                                        </div>
                                    </div>
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        <div class="layui-input-inline">
                                            <input type="text" id="tiwenEndSearch" style="width: 100px;" class="form-control form-control-sm" onchange="tiwenChickValue(this)"
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //姓名
            var laifangNameSearchInput = $('#laifangNameSearch');
            if( laifangNameSearchInput != null){
                if (laifangNameSearchInput.val() != null && laifangNameSearchInput.val() != '') {
                    searchForm.laifangName = $('#laifangNameSearch').val();
                }
            }
     
            //手机号
            var laifangPhoneSearchInput = $('#laifangPhoneSearch');
            if( laifangPhoneSearchInput != null){
                if (laifangPhoneSearchInput.val() != null && laifangPhoneSearchInput.val() != '') {
                    searchForm.laifangPhone = $('#laifangPhoneSearch').val();
                }
            }
     
            //身份证号
            var laifangIdNumberSearchInput = $('#laifangIdNumberSearch');
            if( laifangIdNumberSearchInput != null){
                if (laifangIdNumberSearchInput.val() != null && laifangIdNumberSearchInput.val() != '') {
                    searchForm.laifangIdNumber = $('#laifangIdNumberSearch').val();
                }
            }
     
            //体温
            var tiwenStartSearchInput = $('#tiwenStartSearch');
            if(tiwenStartSearchInput != null){
                var tiwenStartSearchValue = tiwenStartSearchInput.val();
                if( tiwenStartSearchValue  != 0){
                    searchForm.tiwenStart = tiwenStartSearchValue;
                }
            }
            var tiwenEndSearchInput = $('#tiwenEndSearch');
            if(tiwenEndSearchInput != null){
                var tiwenEndSearchValue = tiwenEndSearchInput.val();
                if( tiwenEndSearchValue  != 0){
                    searchForm.tiwenEnd = tiwenEndSearchValue;
                }
            }
                            getDataList();
        }
        ...
        function getDataList() {
            http("laifang/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,
                order: sortOrder,
                //本表的
                laifangName: searchForm.laifangName,
                laifangPhone: searchForm.laifangPhone,
                laifangIdNumber: searchForm.laifangIdNumber,
                tiwenStart: searchForm.tiwenStart,
                tiwenEnd: searchForm.tiwenEnd,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //姓名
            var laifangNameCell = document.createElement('td');
            laifangNameCell.innerHTML = item.laifangName;
            row.appendChild(laifangNameCell);


            //手机号
            var laifangPhoneCell = document.createElement('td');
            laifangPhoneCell.innerHTML = item.laifangPhone;
            row.appendChild(laifangPhoneCell);


            //身份证号
            var laifangIdNumberCell = document.createElement('td');
            laifangIdNumberCell.innerHTML = item.laifangIdNumber;
            row.appendChild(laifangIdNumberCell);
            ...
            //来访事由
            var laifangShiyouCell = document.createElement('td');
            laifangShiyouCell.innerHTML = item.laifangShiyou;
            row.appendChild(laifangShiyouCell);


                //备注
            var laifangContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.laifangContent && item.laifangContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.laifangContent.indexOf('<img');
                var endIndex = item.laifangContent.indexOf('>');
                    laifangContentCell.innerHTML = item.laifangContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.laifangContent != null && item.laifangContent != "" && item.laifangContent.length >= 11) {
                        laifangContentCell.innerHTML = item.laifangContent.substring(0, 10) + "...";
                } else {
                        laifangContentCell.innerHTML = item.laifangContent;
                }
            }
            row.appendChild(laifangContentCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("laifang/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addlaifang", "addlaifang");
            window.location.href = "add-or-update.jsp"
        }
