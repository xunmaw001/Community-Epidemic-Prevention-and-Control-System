            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">核酸检测登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <div class="form-group col-md-6">
                                    <label>检测结果</label>
                                    <input id="jianceValue" name="jianceValue" class="form-control"
                                           v-model="ruleForm.jianceValue" readonly>
                                </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.jianceContent != null && ruleForm.jianceContent != 'null' && ruleForm.jianceContent != '') {
            var jianceContentUeditor = UE.getEditor('jianceContentEditor');
                jianceContentUeditor.ready(function () {
                    var mes = '' + ruleForm.jianceContent;
                    jianceContentUeditor.setContent(mes);
                    jianceContentUeditor.setDisabled('fullscreen');
            });
        }
    }
