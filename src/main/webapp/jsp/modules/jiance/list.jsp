...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">核酸检测管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">核酸检测列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">核酸检测列表</h3>
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        检测结果
                                        <div class="layui-input-inline">
                                            <select name="jianceTypesSelectSearch"  style="width: 150px;" id="jianceTypesSelectSearch" class="form-control form-control-sm"
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            if( insertTimeEndSearch != null){
                ...
                //检测结果
            var jianceTypesSelectSearchInput = document.getElementById("jianceTypesSelectSearch");
            if(jianceTypesSelectSearchInput != null){
                var jianceTypesIndex = jianceTypesSelectSearchInput.selectedIndex;
                if( jianceTypesIndex  != 0){
                    searchForm.jianceTypes= document.getElementById("jianceTypesSelectSearch").options[jianceTypesIndex].value;
                }
            }
                    getDataList();
        }
        ...
        function getDataList() {
            http("jiance/page", "GET", {
                ...
                jianceTypes: searchForm.jianceTypes,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //检测结果
            var jianceTypesCell = document.createElement('td');
            jianceTypesCell.innerHTML = item.jianceValue;
            row.appendChild(jianceTypesCell);


                //备注
            var jianceContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.jianceContent && item.jianceContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.jianceContent.indexOf('<img');
                var endIndex = item.jianceContent.indexOf('>');
                    jianceContentCell.innerHTML = item.jianceContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.jianceContent != null && item.jianceContent != "" && item.jianceContent.length >= 11) {
                        jianceContentCell.innerHTML = item.jianceContent.substring(0, 10) + "...";
                } else {
                        jianceContentCell.innerHTML = item.jianceContent;
                }
            }
            row.appendChild(jianceContentCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("jiance/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addjiance", "addjiance");
            window.location.href = "add-or-update.jsp"
        }
    ...
    //填充本表搜索下拉框
        ...
        function jianceTypesSelectSearch() {
            var jianceTypesSelectSearch = document.getElementById('jianceTypesSelectSearch');
            if(jianceTypesSelectSearch != null) {
                jianceTypesSelectSearch.add(new Option('-请选择-',''));
                if (jianceTypesOptions != null && jianceTypesOptions.length > 0){
                    for (var i = 0; i < jianceTypesOptions.length; i++) {
                            jianceTypesSelectSearch.add(new Option(jianceTypesOptions[i].indexName,jianceTypesOptions[i].codeIndex));
                    }
                }
            }
        }
